...
class Trainer:
    ...
    def __init__(self, args):
        ...
        train_names = [str(slice_name).split('.')[0] for slice_name in os.listdir(self._train_dir)]
        val_names = [str(slice_name).split('.')[0] for slice_name in os.listdir(self._val_dir)]
